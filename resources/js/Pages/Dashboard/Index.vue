...
const dashboardLabels = computed(() => ({
    ...
    cartAbandonment: t('dashboard.cart_abandonment', 'Carrinho abandonado / compras'),
    abandonedCount: t('dashboard.abandoned_count', 'abandonados'),
    purchasesCount: t('dashboard.purchases_count', 'compras'),
...
const sharedViewProps = computed(() => ({
    ...
    taxa_abandono_compras: props.taxa_abandono_compras,
    compras_periodo: props.compras_periodo,
